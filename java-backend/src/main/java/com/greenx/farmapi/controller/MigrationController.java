...
public class MigrationController {
    ...
    public ApiResponse<Map<String, Object>> ensureWorkflowEventsTable() {
        ...
        try {
            ...
            jdbcTemplate.execute("CREATE UNIQUE INDEX UQ_WORKFLOW_EVENTS_FARM_EVENT ON WORKFLOW_EVENTS(FARM_ID, EVENT_KEY)");
            ...
            jdbcTemplate.execute("ALTER TABLE WORKFLOW_EVENTS ADD CONSTRAINT CK_WORKFLOW_EVENTS_STATUS CHECK (STATUS IN ('pending', 'in-progress', 'completed'))");
