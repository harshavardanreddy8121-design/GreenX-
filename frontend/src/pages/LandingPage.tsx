    ...
    return (
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hiw-connector {
          ...
          bottom: 0;
          width: 2px;
          background: linear-gradient(to bottom, rgba(34,197,94,0.35), rgba(34,197,94,0.06));
        }
        .hiw-icon-col {
          flex-shrink: 0;
          position: relative;
      ...
      `}</style>
            ...
            {/* ══ HOW IT WORKS ══ */}
            <section id="how-it-works" className="reveal" style={{ background: 'var(--black)', padding: '120px 60px' }}>
                <div style={{ maxWidth: '900px', margin: '0 auto' }}>
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '80px' }}>
                        ...
                        <p className="section-sub" style={{ margin: '16px auto 0', textAlign: 'center' }}>
                            5 Simple Steps to Professional Farming
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: 'Submit your land documents (7/12, survey map) through our platform. Our team verifies ownership and eligibility within 48 hours — no paperwork hassle.',
                                color: 'var(--green)',
                            ...
                            },
                            {
                                ...
                                desc: 'We aggregate nearby parcels from multiple landowners into a single, professionally managed farm unit — unlocking economies of scale impossible for individual smallholders.',
                                color: 'var(--green)',
                                accent: 'rgba(34,197,94,0.12)'
                            },
                            {
                                ...
                                desc: 'Clinical NPK, pH, and micronutrient analysis is conducted on every plot. Expert agronomists then build a custom crop calendar and precision input schedule tailored to your soil.',
                                color: 'var(--green)',
                                accent: 'rgba(34,197,94,0.12)'
                            },
                            {
                                num: '04',
                                icon: <Wheat size={24} strokeWidth={1.8} />,
                                title: 'Professional Cultivation',
                                desc: 'Our trained field workforce executes every stage — planting, irrigation, pest control, and harvest — using precision agriculture tools, GPS tracking, and Variable Rate Technology.',
                                color: 'var(--green)',
                                accent: 'rgba(34,197,94,0.12)'
                            },
                            {
                                num: '05',
                                icon: <Ship size={24} strokeWidth={1.8} />,
                                title: 'Direct Export & Profit Split',
                                desc: 'Produce is graded, packed, and sold directly to international buyers — bypassing 5 layers of middlemen. 70% of net profits are transferred directly to the landowner\'s account.',
                                color: 'var(--gold)',
                                accent: 'rgba(212,168,71,0.12)'
                            }
                        ].map((step, i, arr) => (
                            <div key={i} className="hiw-step">
                                ...
                                <div className="hiw-icon-col">
                                    <div className="hiw-icon-wrap" style={{ borderColor: step.color, background: step.accent, color: step.color }}>
                                        {step.icon}
                                    </div>
                                </div>
