...
import { FlaskConical, Droplets, Leaf, Waves, Download, Calendar } from 'lucide-react';
                                ...
                                <>
                                    <div className="grid md:grid-cols-4 gap-4 mb-4">
                                        <Card className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border-blue-200">
                                            ...
                                            <p className="text-xs text-blue-700">{parseFloat(farm.soil_details.soil_ph) >= 6.5 && parseFloat(farm.soil_details.soil_ph) <= 7.5 ? '✅ Optimal' : '⚠️ Needs attention'}</p>
                                        </Card>
                                        ...
                                        <Card className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
                                            ...
                                            <p className="text-xs text-green-700">{parseFloat(farm.soil_details.soil_nitrogen) >= 280 ? '✅ High' : parseFloat(farm.soil_details.soil_nitrogen) >= 140 ? '⚡ Medium' : '⚠️ Low'}</p>
                                        </Card>
                                        ...
                                        <Card className="p-4 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
                                            ...
                                            <p className="text-xs text-amber-700">{parseFloat(farm.soil_details.soil_phosphorus) >= 22 ? '✅ High' : parseFloat(farm.soil_details.soil_phosphorus) >= 11 ? '⚡ Medium' : '⚠️ Low'}</p>
                                        </Card>
                                        ...
                                        <Card className="p-4 bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
                                            ...
                                            <p className="text-xs text-purple-700">{parseFloat(farm.soil_details.soil_potassium) >= 280 ? '✅ High' : parseFloat(farm.soil_details.soil_potassium) >= 110 ? '⚡ Medium' : '⚠️ Low'}</p>
                                        </Card>
                                    </div>
