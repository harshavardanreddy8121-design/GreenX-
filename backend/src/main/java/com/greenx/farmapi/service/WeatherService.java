...
/**
 * Fetches real-time weather data from WeatherAPI.com and caches results for
 * 30 minutes to stay within free-tier rate limits.
 *
...
public class WeatherService {
     ...
     * Results are cached for 30 minutes (configured via CacheConfig TTL).
     *
    ...
    private CurrentWeather mapCurrent(Map<String, Object> cur) {
        ...
        // Map WeatherAPI condition code to a simplified weather_code
        // (0 = clear, 1 = partly cloudy, 3 = overcast, 61+ = rain, 80+ = heavy rain)
    ...
    private int mapConditionCode(int apiCode) {
        // WeatherAPI codes: 1000=sunny, 1003=partly cloudy, 1006=cloudy,
        // 1009=overcast, 1063/1180-1201=rain, 1273-1282=thunder
